...
//  // 初始化颜色管理器
//  const isDark = colorManager.currentTheme === 'dark';
//  const colors = colorManager.colors;
//
//  // 清除现有SVG内容
...
//    Swal.fire({ icon: 'error', title: '无效的图谱数据' });
//    return;
//  }
//
...
//      .attr("fill", colors.arrow[type]);
//  });
//
//  // 2. 创建连线
//  linkRef = container.append("g")
//    .selectAll("line")
//    .data(graphData.links)
//    .enter()
//    .append("line")
//    .attr("class", "link-line")
//    .attr("stroke", colors.link.normal)
...
//    .text(d => d.label)
//    .attr("font-size", 10)
//    .attr("fill", colors.link.text);
//
//  // 4. 创建节点
//  nodeRef = container.append("g")
//    .selectAll("circle")
...
//    })
//    .attr("fill", d => colors.node[d.type] || colors.node.default)
//    .attr("stroke", d =>
//      d3.color(colors.node[d.type] || colors.node.default).darker(0.5)
//    )
...
//    .attr("dx", 25)
//    .attr("dy", ".3em")
//    .attr("fill", colors.label.primary)
//    .attr("font-weight", "bold")
//    .attr("paint-order", "stroke")
//    .attr("stroke", colors.label.stroke)
//    .attr("stroke-width", 1);
//
//  // 6. 力导向模拟
...
//      colorManager.updateAllElements(); // 使用颜色管理器重置样式
//      nodeRef.attr("opacity", 1);
//    });
//
//  // 工具函数
