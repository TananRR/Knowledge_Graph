...
if __name__ == "__main__":
    ...
    text1='在北京，故宫博物院是著名的历史文化遗产，吸引了来自世界各地的游客。故宫位于北京市中心，由明清两代皇帝居住和办公。每年，故宫接待超过一千万游客。与此同时，北京大学作为中国顶尖的高等学府，培养了大量杰出人才。北京大学坐落于北京市海淀区，拥有丰富的教学资源和科研实力。故宫与北京大学都是北京市的重要文化符号。此外，长城作为中国古代防御工程的代表，横贯北方多个省份，是世界文化遗产的重要组成部分。长城的建造始于春秋战国时期，历经多个朝代修筑和完善。'
    # text1='河南省，简称“豫”，是中国历史文化的重要发源地之一。省会郑州是中原地区的政治、经济和文化中心。河南拥有众多著名的旅游景点，如少林寺、龙门石窟、云台山、开封古城和嵩山。少林寺位于河南省登封市，是中国禅宗和武术的发源地，以其深厚的佛教文化和功夫闻名于世。龙门石窟位于洛阳市南郊，始建于北魏时期，拥有大量精美的佛教石刻艺术，是世界文化遗产。云台山风景区位于焦作市，以奇峰怪石、峡谷瀑布和丰富的植被生态闻名，吸引众多游客。开封古城是中国七大古都之一，保存了丰富的历史建筑和文化遗迹，如铁塔和清明上河园。嵩山是中国五岳之一，既是佛教圣地也是道教名山，山上有著名的少林寺和中岳庙。河南的旅游资源不仅丰富，还融合了深厚的历史文化底蕴，是体验中华文明的重要窗口。'
